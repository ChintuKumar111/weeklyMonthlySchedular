package com.example.freshyzoappmodule.ViewPager_.view.Activity
...
import com.example.freshyzoappmodule.ViewPager_.view.adapter.ProductAdapter
...
class ProductListActivity : AppCompatActivity() {
    ...
    private fun setupRecyclerView() {
        adapter = ProductAdapter { product: ProductResponse ->
