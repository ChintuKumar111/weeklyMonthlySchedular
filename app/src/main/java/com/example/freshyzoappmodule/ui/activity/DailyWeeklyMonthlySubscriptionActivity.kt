...
//
//import com.example.freshyzoappmodule.ui.viewmodel.MainViewModel
...
//        val dayListObserver = androidx.lifecycle.Observer<List<com.example.freshyzoappmodule.data.model.DayAndDates>> { list ->
