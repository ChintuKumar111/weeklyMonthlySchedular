...
class MainViewModel : ViewModel() {
    ...
    private val _dayList = MutableLiveData<List<DayAndDates>>(
        listOf(
            DayAndDates("Mon", 0, false),
            DayAndDates("Tue", 0, false),
            DayAndDates("Wed", 0, false),
            DayAndDates("Thu", 0, false),
            DayAndDates("Fri", 0, false),
            DayAndDates("Sat", 0, false),
            DayAndDates("Sun", 0, false)
        )
    )
    val dayList: LiveData<List<DayAndDates>> = _dayList
