...
class ProfileFragment : Fragment() {
    ...
    private fun loadProfileData() {
        ...
        val savedDob = PreferenceHelper.getUserDob(requireContext())
    ...
    private fun saveProfileChanges() {
        ...
        PreferenceHelper.saveUserName(requireContext(), newName)
        PreferenceHelper.saveUserDob(requireContext(), newDob)
