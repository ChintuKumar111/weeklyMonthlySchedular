...
import com.shyamdairyfarm.user.databinding.ItemProductMediaBinding
        ...
        fun bindVideo(videoUrl: String) {
            ...
            if (player == null) {
                val httpDataSourceFactory = DefaultHttpDataSource.Factory()
                    .setUserAgent(Util.getUserAgent(binding.root.context, binding.root.context.packageName))
